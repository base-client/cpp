...
bool AdminSocketClientJob::Start()
{
	...
	return this->socketServer.Start(socketClientConfig.GetAdminPort(), socketClientConfig.GetAdminTimeout(), 1, job);
}

bool AdminSocketClientJob::Stop()
{
	DEBUG_G(__PRETTY_FUNCTION__);
